...
RUN wget -q -O - https://dl.google.com/linux/linux_signing_key.pub | apt-key add - && \
    ...
    apt-get update && \
    apt-get install -y google-chrome-stable=130.0.6723.69-1 

# Install the specific version of ChromeDriver for Linux
RUN wget -N https://edgedl.me.gvt1.com/edgedl/chrome/chrome-for-testing/130.0.6723.69/linux64/chromedriver-linux64.zip && \
